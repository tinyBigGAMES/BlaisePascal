...
const
  OperatorsInfo: array [0..27] of TOperatorInfo =
    ((Typ: ntAddr;         Priority: 1; Kind: okUnary;  AssocType: atRight),  // Unary @ (address-of)
     ...
     (Typ: ntGeneric;      Priority: 1; Kind: okBinary; AssocType: atLeft),   // Generic type <>
     (Typ: ntIndexed;      Priority: 1; Kind: okUnary;  AssocType: atLeft),   // Array indexing []
     (Typ: ntDot;          Priority: 2; Kind: okBinary; AssocType: atLeft),   // Member access .
     (Typ: ntCall;         Priority: 3; Kind: okBinary; AssocType: atLeft),   // Function call ()
     ...
     (Typ: ntMul;          Priority: 7; Kind: okBinary; AssocType: atLeft),   // Binary *
     (Typ: ntFDiv;         Priority: 7; Kind: okBinary; AssocType: atLeft),   // Binary /
     (Typ: ntDiv;          Priority: 7; Kind: okBinary; AssocType: atLeft),   // Binary div
     (Typ: ntMod;          Priority: 7; Kind: okBinary; AssocType: atLeft),   // Binary mod
     (Typ: ntAnd;          Priority: 7; Kind: okBinary; AssocType: atLeft),   // Binary and
     (Typ: ntShl;          Priority: 7; Kind: okBinary; AssocType: atLeft),   // Binary shl
     (Typ: ntShr;          Priority: 7; Kind: okBinary; AssocType: atLeft),   // Binary shr
     (Typ: ntAs;           Priority: 7; Kind: okBinary; AssocType: atLeft),   // Type cast as
     (Typ: ntAdd;          Priority: 8; Kind: okBinary; AssocType: atLeft),   // Binary +
     (Typ: ntSub;          Priority: 8; Kind: okBinary; AssocType: atLeft),   // Binary -
     (Typ: ntOr;           Priority: 8; Kind: okBinary; AssocType: atLeft),   // Binary or
     (Typ: ntXor;          Priority: 8; Kind: okBinary; AssocType: atLeft),   // Binary xor
     (Typ: ntEqual;        Priority: 9; Kind: okBinary; AssocType: atLeft),   // Comparison =
     (Typ: ntNotEqual;     Priority: 9; Kind: okBinary; AssocType: atLeft),   // Comparison <>
     (Typ: ntLower;        Priority: 9; Kind: okBinary; AssocType: atLeft),   // Comparison <
     (Typ: ntGreater;      Priority: 9; Kind: okBinary; AssocType: atLeft),   // Comparison >
     (Typ: ntLowerEqual;   Priority: 9; Kind: okBinary; AssocType: atLeft),   // Comparison <=
     (Typ: ntGreaterEqual; Priority: 9; Kind: okBinary; AssocType: atLeft),   // Comparison >=
     (Typ: ntIn;           Priority: 9; Kind: okBinary; AssocType: atLeft),   // Set membership in
     (Typ: ntIs;           Priority: 9; Kind: okBinary; AssocType: atLeft));  // Type check is
